...
namespace Pladeco.Web.Controllers
{
    ...
    public class SectorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,ID")] Sector sector)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,ID")] Sector sector)
        {
            if (id != sector.ID)
            {
                return NotFound();
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var ticketChannel = await _context.Sectors
                .FirstOrDefaultAsync(m => m.ID == id);
